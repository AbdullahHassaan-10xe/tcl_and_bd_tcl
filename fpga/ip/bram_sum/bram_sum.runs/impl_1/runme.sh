...
HD_PWD='/home/xe-lpt-47/Documents/Maple/Pre-boarding/DLD/Vivado_Project_simulations/sum_an_array_lec10/bram_sum/bram_sum.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_sum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_sum.tcl -notrace
